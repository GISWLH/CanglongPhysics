"""
CAS-Canglong V2 训练脚本
V2版本：在V1基础上添加风向感知的Mask & Combine窗口移位策略
"""
...
from canglong.wind_aware_shift import WIND_DIR_NAMES, get_dominant_direction, get_regional_dominant_directions
...
if __name__ == '__main__':
    ...
    # 加载数据
    print("Loading data...")
    input_surface = h5.File('/gz-data/ERA5_2023_weekly_new.h5')['surface']
    input_upper_air = h5.File('/gz-data/ERA5_2023_weekly_new.h5')['upper_air']
    ...
    print("=" * 60)
    print("Training V2 with Wind-Aware Mask & Combine Shift")
    print("=" * 60)
    print(f"Wind shift mode: regional (4x8=32 regions)")
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        for input_surface, input_upper_air, target_surface, target_upper_air in train_pbar:
            ...
            if first_batch and epoch == start_epoch:
                regional_dirs = get_regional_dominant_directions(wind_direction_id, (4, 8))
