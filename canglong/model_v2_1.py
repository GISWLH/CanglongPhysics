"""
CAS-Canglong V2.1 model.
Wind-aware global shift with a matching attention mask.
"""
...
from .wind_direction_v2_1 import WindDirectionProcessorV2_1
from .wind_aware_block_v2_1 import WindAwareEarthSpecificBlockV2_1
...
class BasicLayerV2_1(nn.Module):
    ...
    def __init__(self, dim, input_resolution, depth, num_heads, window_size, mlp_ratio=4., qkv_bias=True, qk_scale=None,
        ...
        self.blocks = nn.ModuleList([
            WindAwareEarthSpecificBlockV2_1(
                dim=dim,
...
class CanglongV2_1(nn.Module):
    """
    CAS Canglong V2.1: wind-aware 3D Transformer with global shift + matching mask.
    ...
    def __init__(self, embed_dim=96, num_heads=(8, 16, 16, 8), window_size=(2, 6, 12),
        ...
        self.wind_direction_processor = WindDirectionProcessorV2_1(
