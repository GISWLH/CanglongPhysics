...
class WindAwareEarthSpecificBlockV2_2(nn.Module):
    """
    ...
    def _forward_impl(self, x: torch.Tensor, wind_direction_id=None):
    ...
    def forward(self, x: torch.Tensor, wind_direction_id=None):
        return self._forward_impl(x, wind_direction_id)
