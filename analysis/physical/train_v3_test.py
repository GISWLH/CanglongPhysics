...
# ============ 全局缓存的常量掩码 ============
# 使用项目根目录下的constant_masks (PROJECT_ROOT已在文件开头定义)
...
json = str(PROJECT_ROOT / 'code_v2/ERA5_1940_2023_mean_std_v2.json')
...
save_dir = str(PROJECT_ROOT / 'checkpoints_v3_test')
