...
Z:\Data\hindcast_2022_2023_lead1.nc to Z:\Data\hindcast_2022_2023_lead6.nc
...
2. 降水距平TCC
用每个week减去历史week的降水，得到降水距平，可以绘制lead1 to lead6的降水距平时间序列，计算lead1 to lead6的曲线和obs_anom的相关系数，就是lead 1to lead6的降水TCC

3. 温度距平TCC
和降水距平分析完全一样

4. 土壤水距平TCC
和降水分析方式相同，但是改为土壤水，但注意土壤水的历史平均态不在原始nc里，只能通过2022-2023进行一个简单的climatology，其余和降水分析一致。
